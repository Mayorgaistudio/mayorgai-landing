...
function FAQItem({
  ...
  return (
    <motion.div
      ...
      variants={variants}
      className={`relative border rounded-2xl overflow-hidden transition-all duration-300 group ${
        isOpen
          ? "border-[#6D5DFB]/40 bg-purple/5 dark:bg-white/[0.04] shadow-md shadow-purple/5"
          : "border-slate-200/80 dark:border-white/[0.07] bg-slate-50/70 dark:bg-white/[0.015] hover:border-slate-300 dark:hover:border-white/[0.15]"
      }`}
    >
      ...
      <div
        ...
        style={{
          background: `radial-gradient(400px circle at ${mousePos.x}px ${mousePos.y}px, rgba(109, 93, 251, 0.22), rgba(0, 212, 255, 0.08) 40%, transparent 80%)`,
        }}
      />
      ...
      <button
        onClick={onToggle}
        className="relative z-20 w-full text-left p-6 flex justify-between items-center gap-4 focus:outline-none cursor-pointer"
      >
        <span className="text-base sm:text-lg font-medium text-slate-900 dark:text-white tracking-tight">
          {faq.q}
        </span>
        ...
        <div className="w-6 h-6 shrink-0 flex items-center justify-center relative">
          <span
            className={`w-4 h-[2px] bg-slate-400 dark:bg-silver rounded-full absolute transition-transform duration-300 ${
              isOpen ? "rotate-180 bg-[#6D5DFB] dark:bg-[#00D4FF]" : ""
            }`}
          />
          <span
            className={`w-[2px] h-4 bg-slate-400 dark:bg-silver rounded-full absolute transition-transform duration-300 ${
      ...
      <AnimatePresence initial={false}>
        {isOpen && (
          ...
          >
            <p className="text-slate-600 dark:text-silver/60 text-sm leading-relaxed font-normal px-6 pb-6 pt-0">
              {faq.a}
            </p>
          </motion.div>
        )}
...
export default function FAQ() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: "Combinamos la creatividad con la inteligencia artificial y la automatización. Esto significa que obtienes un diseño de alto impacto y sistemas inteligentes que impulsan el crecimiento, no solo una página web estándar.",
    },
    {
    ...
    <section id="faq" className="py-24 md:py-32 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-start">
          ...
          {/* LEFT COLUMN: FAQ ACCORDION WITH SPOTLIGHT */}
          ...
          <div className="flex flex-col items-start w-full">
            ...
            <div className="w-full rounded-2xl overflow-hidden border border-slate-200/80 dark:border-white/[0.07] bg-slate-50/70 dark:bg-white/[0.015] p-1 min-h-[380px] self-stretch">
              <div 
            ...
            {/* Social Icons row */}
            <div className="flex items-center gap-4 mt-6 pt-5 border-t border-slate-200/60 dark:border-white/[0.06] w-full">
